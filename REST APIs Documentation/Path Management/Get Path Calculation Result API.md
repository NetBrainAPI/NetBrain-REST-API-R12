...
***Note:***: It is recommended to use [Get Path Calculation Overview API](https://github.com/NetBrainAPI/NetBrain-REST-API-R12/blob/main/REST%20APIs%20Documentation/Path%20Management/Get%20Path%20Calculation%20Overview.md) as its result offers more details.
